...
// verifica se as cartas da jogada atual estÃ£o presentes na mÃ£o do jogador
...
// retira da mÃ£o do jogador as cartas presentes na jogada atual
...
// escrever combinacaoValida que testa se a jogada recebida como argumento Ã© conjunto, seq ou dupla seq
...
// verifica se a jogada Ã© vÃ¡lida e modifica a mÃ£o do jogador
int aplicaJogada(wchar_t maoCartas[], wchar_t jogadasAnteriores[][1000], int numJogadasAnteriores, wchar_t jogadaAtual[])
{

    // verifica se as cartas jogadas pertencem Ã  mÃ£o do jogador e sÃ£o uma jogada vÃ¡lida
...
int main()
{
    ...
    for (int i = 0; i < testes; i++)
    {
        ...
        // determina o nÃºmero de cartas na mÃ£o do jogador depois da jogada
        if (jogadaAplicada) tamanhoMao -= wcslen(jogadaAtual);

        // ordena as cartas
        isort(maoCartas, tamanhoMao);

        // imprime a mÃ£o do jogador
        imprimeMao(maoCartas, tamanhoMao);
